...
const reviews = [
  {
    quote:
      'The kind of coat that changes the way you walk through a city.',
    name: 'Amelia R.',
    city: 'London'
  },
  {
    quote:
      'A rare balance of restraint and presence. Every detail feels intentional.',
    name: 'Noah K.',
    city: 'Copenhagen'
  },
  {
    quote:
      'Quietly exceptional. The knit has become the most worn thing in my wardrobe.',
    name: 'Mina S.',
    city: 'New York'
  }
];
...
function App() {
  ...
  const [bag, setBag] = useState(() =>
    JSON.parse(
      localStorage.getItem('maison-noir-bag') || '[]'
    )
  );
  ...
  return (
    <div className="app-shell">
        ...
        <section className="story-section" id="story">
          ...
          <div className="story-copy">
            ...
            <a
              ...
              href="#journal"
            >
              More about the house <ArrowRight size={16} />
            </a>
          </div>
        </section>
      ...
      <footer className="site-footer">
        ...
        <p>
          © 2024 Maison Noir. Made with intention.
        </p>
      </footer>
